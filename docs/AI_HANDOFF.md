...
points to verified commit `c6a6211` for source/Action consumption. Do not
assume npm publication, a stable public API, or production-scale compatibility
...
Maintenance run 2026-09-16 (hardening follow-up): maintainer published GitHub
Pre-release `v0.1.0-alpha.2` at verified commit `c6a6211`. It rejects path-like
journal tags, preserves original journal positions after malformed metadata,
...
4. M4 — GitHub Action distribution ✅ (`v0.1.0-alpha.2`; npm and `@v1` remain separate maintainer gates)
